    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                excelWorkBook.SaveAs(saveFileDialog1.FileName, Excel.XlFileFormat.xlWorkbookNormal);
        ...
        private void UpdateInformation()
        {
            ...
            {
                label1.Text = $"Статистика использования приложения за {File.GetLastWriteTime("images.db")}";
            }
            _numberOfImages = -1;
